	...
	switch (mAction)
	{
		case Action::addPlayer1:
		{
			if (team.numberOfMembers < 18)
				insertPlayerOne("tank1", sf::Vector2f(300.0f, 300.0f), sf::Vector2f(300.0f, 300.0f), 100.0f, 15.0f, team, team.mAddPosition);
			break;
		}
		...
		{
			if (team.numberOfMembers < 18)
				insertPlayerTwo("tank1", sf::Vector2f(250.0f, 250.0f), sf::Vector2f(300.0f, 300.0f), 100.0f, 15.0f, team, team.mAddPosition);
			break;
		}
		...
		{
			if (team.numberOfMembers < 18)
				insertAI("easy", "tank2", sf::Vector2f(500.0f, 500.0f), sf::Vector2f(150.0f, 150.0f), 80.0f, 10.0f, team, team.mAddPosition);
			break;
		}
		...
		{
			if (team.numberOfMembers < 18)
				insertAI("medium", "tank2", sf::Vector2f(900.0f, 600.0f), sf::Vector2f(150.0f, 150.0f), 100.0f, 15.0f, team, team.mAddPosition);
			break;
		}
		...
		{
			if(team.numberOfMembers < 18)
				insertAI("hard", "tank2", sf::Vector2f(700.0f, 700.0f), sf::Vector2f(150.0f, 150.0f), 120.0f, 20.0f, team, team.mAddPosition);
			break;
		}
